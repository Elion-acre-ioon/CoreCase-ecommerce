...
if (cloudinaryConfigurado) {
    ...
    console.log('[imageStorage] CLOUDINARY_API_SECRET tamanho:', (process.env.CLOUDINARY_API_SECRET || '').length, '- primeiros 4 caracteres:', (process.env.CLOUDINARY_API_SECRET || '').slice(0, 4));
